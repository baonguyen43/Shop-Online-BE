...
module.exports = {
    getDetail: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const result = yield cartRepository.findOneBy({ customerId });
            if (result) {
    ...
    create: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const customer = yield customerRepository.findOneBy(customerId);
            console.log(customer);
            if (!customer) {
                return res.status(404).json({ error: 'Khách hàng không tồn tại' });
            }
            const product = yield productRepository.findOneBy(productId);
            console.log(product);
